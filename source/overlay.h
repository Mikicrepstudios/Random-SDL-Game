...
namespace overlay {
	extern void Inventory(SDL_Renderer* renderer, TTF_Font* font, bool inventory, bool colorPick, bool bgcolorPick, bool playerColorPick, bool gameInfo, int blockColor, int bgColor,  int playerColor, int mouseX, int mouseY);
