			...
			if (!settings.cheats) {
				if(sdlSettings.isMouseDown) {
					...
					if (mouseButtons & SDL_BUTTON(SDL_BUTTON_LEFT)) {
						...
						map.map[sdlSettings.curHoverX - cam.offSetX][sdlSettings.curHoverY - cam.offSetY].texture = settings.blockTextureId;
						...
						map.map[sdlSettings.curHoverX - cam.offSetX][sdlSettings.curHoverY - cam.offSetY].texture = 0;
