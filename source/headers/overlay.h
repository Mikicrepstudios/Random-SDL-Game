...
namespace overlay {
	extern void Inventory(SDL_Renderer* renderer, TTF_Font* font, inventory::rects rects, bool inventory, bool colorPick, bool bgcolorPick, bool playerColorPick, bool gameInfo, int blockColor, int bgColor,  int playerColor, int width, int height, int mouseX, int mouseY, int preset);
