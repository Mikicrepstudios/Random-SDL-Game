...
namespace player {
	...
	extern void InventoryEvent(SDL_Event event, game::Settings &settings, game::SDL_Settings &sdlSettings);
	...
	extern int ColorPickerEvent(game::SDL_Settings sdlSettings, game::Settings &settings, int pickerId);
}
