...
namespace player {
    ...
    extern void mouseinvchooser(SDL_Event event, bool inventory, int worldmap[250][250], int mapwidth, int mapheight, int &curblock, int &bgcolor, int mousex, int mousey);
}
