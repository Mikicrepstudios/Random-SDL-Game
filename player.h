...
namespace player {
    ...
    extern void mouseevent(SDL_Event event, int worldmap[250][250], int mapwidth, int mapheight, int curhoverx, int curhovery, int &curblock, int camoffsetx, int camoffsety);
