...
windows: $(wildcard source/*.cpp) $(wildcard source/*/*.cpp)
	x86_64-w64-mingw32-g++ $^ -o main.exe -I./source/headers -Isdl2mingw/include/SDL2 -Lsdl2mingw/lib -static-libstdc++ -static-libgcc -lmingw32 -lSDL2main -lSDL2_image -lSDL2_ttf -lSDL2
