...
windows32: $(wildcard source/*.cpp) $(wildcard source/*/*.cpp)
	echo "You must have "sdl2mingw32" folder. More info in README.md"
	i686-w64-mingw32-g++ $^ -o output32/sdlgaemx86.exe -I./source/headers -Isdl2mingw32/include/SDL2 -Lsdl2mingw32/lib -static-libstdc++ -static-libgcc -lmingw32 -lSDL2main -lSDL2_image -lSDL2_ttf -lSDL2
