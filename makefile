...
output/sdlgaem: $(wildcard source/*.cpp) $(wildcard source/*/*.cpp) $(wildcard source/*/*/*.cpp)
	g++ $^ -o $@ -fsanitize=address -lSDL2 -lSDL2_image -lSDL2_ttf -I/usr/include/SDL2 -I./source/headers
...
windows32: $(wildcard source/*.cpp) $(wildcard source/*/*.cpp) $(wildcard source/*/*/*.cpp)
	...
	i686-w64-mingw32-g++ $^ -o output/sdlgaemx86.exe -I./source/headers -Isdl2mingw32/include/SDL2 -Lsdl2mingw32/lib -g -static-libstdc++ -static-libgcc -lmingw32 -lSDL2main -lSDL2_image -lSDL2_ttf -lSDL2
