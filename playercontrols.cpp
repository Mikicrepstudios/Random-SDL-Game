...
namespace player {
    void mouseevent(SDL_Event event, int worldmap[250][250], int curhoverx, int curhovery, int &curblock, int camoffsetx, int camoffsety) {
...
namespace overlay {
    void mouse(SDL_Renderer* renderer, int worldmap[250][250], int curhoverx, int curhovery, int camoffsetx, int camoffsety) {
        if (worldmap[curhoverx - camoffsetx][curhovery - camoffsety] != 1) {
